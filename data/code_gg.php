...
function getAuthImage($text) {
	...
	$tmpC0=mt_rand(255,255);
	$tmpC1=mt_rand(255,255);
	$tmpC2=mt_rand(255,255);
	...
	for ($i=0;$i<strlen($text);$i++)
	{
		...
		$array = array(-1,1);
		$p = array_rand($array);
		$an = $array[$p]*mt_rand(1,40);//角度
		$size = 35;
		imagettftext($im, $size, $an, 10+$i*$size, 45, $text_c, $font, $tmp);
	}
